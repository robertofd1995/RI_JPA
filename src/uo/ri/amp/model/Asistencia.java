...
public class Asistencia {
    ...
    public Asistencia(Mecanico mecanico, Curso curso
            , Date finicio, Date ffinal, double porcentaje, AsistenciaStatus status) {
    ...
    public String toString() {
        return "Asistencia [asistencia=" + pasistencia.doubleValue() +
                ", curso=" + curso.getNombre() + ", mecanico=" + mecanico.getDni() + ", fInicio="
